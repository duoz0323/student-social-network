...
export default function NotificationsPage() {
  ...
  async function load(signal) {
    ...
    catch (requestError) { if (!isRequestCanceled(requestError)) setError(requestError.message); }
