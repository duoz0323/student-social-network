...
export const messagingApi = Object.freeze({
  ...
  getShareRecipients: (params, signal) => requestData(httpClient.get(`${base}/share-recipients`, { params: compactParams(params), signal })),
  ...
  sendPostShare: (conversationId, payload, signal) => requestData(httpClient.post(`${base}/${conversationId}/messages`, payload, { signal })),
