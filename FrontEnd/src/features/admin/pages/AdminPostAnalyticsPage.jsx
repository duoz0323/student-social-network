...
export default function AdminPostAnalyticsPage() {
  ...
  return <section className="space-y-5 rounded-[28px] bg-zinc-50 p-4 sm:p-6">
    <header className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
      <div><p className="text-xs font-bold uppercase tracking-[.18em] text-blue-600">Post analytics</p><h1 className="mt-1 text-2xl font-bold text-zinc-950">Thống kê bài viết</h1><p className="mt-1 text-sm text-zinc-500">Theo dõi tăng trưởng nội dung, tương tác và hiệu quả kiểm duyệt.</p></div>
