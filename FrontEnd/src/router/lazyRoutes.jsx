...
export const AccountStandingPage = lazy(() => import('../features/account/pages/AccountStandingPage.jsx'));
export const CommunityStandardsPage = lazy(() => import('../features/policy/pages/CommunityStandardsPage.jsx'));
...
export const AdminModerationSuggestionsPage = lazy(() => import('../features/admin/pages/AdminModerationSuggestionsPage.jsx'));
...
export const AdminNotificationsPage = lazy(() => import('../features/admin/pages/AdminNotificationsPage.jsx'));
...
export const CollaboratorIdentityPage = lazy(() => import('../features/admin/collaborator/pages/CollaboratorIdentityPage.jsx'));
export const CollaboratorExplorePage = lazy(() => import('../features/admin/collaborator/pages/CollaboratorExplorePage.jsx'));
export const CollaboratorModerationSuggestionsPage = lazy(() => import('../features/admin/collaborator/pages/CollaboratorModerationSuggestionsPage.jsx'));
