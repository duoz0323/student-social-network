...
public record MessageResponse(Long messageId, Long conversationId, Long senderId,
                              ...
                              SharedPostResponse sharedPost, boolean sharedPostUnavailable,
    ...
    public MessageResponse(Long messageId, Long conversationId, Long senderId, String clientMessageId,
                           MessageType type, String content, List<MessageAttachmentResponse> attachments,
                           LocalDateTime createdAt) {
        this(messageId, conversationId, senderId, clientMessageId, type, content,
                attachments, null, false, createdAt);
    }
}
