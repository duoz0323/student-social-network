...
public interface AuthMethodManagementService {
    ...
    VerifiedEmailLinkResponse verifyEmailOtp(String flowToken, LinkOtpRequest request);
    AuthMethodResponse completeEmailLink(String flowToken, CompleteEmailLinkRequest request);
