...
| AUTH-02 | Đăng ký | `docs/ui/screens/auth/register.jpg` | Khách | Tạo tài khoản mới. | Email hoặc số điện thoại, mật khẩu, xác nhận mật khẩu, đồng ý điều khoản nếu form yêu cầu. | Thành công đến onboarding hồ sơ. | Phạm vi triển khai: MVP_CURRENT. Không triển khai username, displayName trong form đăng ký, Google/Facebook. Chỉ nhập đúng một phương thức định danh tại thời điểm đăng ký. |
| AUTH-03 | Đăng ký thành công | `docs/ui/screens/auth/register-success.jpg` | User chưa hoàn tất hồ sơ | Xác nhận tạo tài khoản thành công nếu UI cần trạng thái trung gian. | Thông báo thành công, nút tiếp tục hoàn tất hồ sơ. | Đi đến onboarding hồ sơ. | Phạm vi triển khai: MVP_CURRENT nếu cần; không thay thế bước onboarding bắt buộc. |
