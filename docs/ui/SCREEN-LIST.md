...
| PROFILE-02 | Hồ sơ người khác | `docs/ui/screens/profile/profile-for-other.jpg` | User | Xem hồ sơ công khai và theo dõi/nhắn tin/báo cáo người khác. | Thông tin người dùng, Follow/Unfollow, Nhắn tin, menu Hạn chế/Báo cáo/Chặn và tab nội dung. | Route `/profile/:userId`; Báo cáo mở modal sáu lý do. | Phạm vi triển khai: MVP_CURRENT. |
