...
CREATE TABLE `admin_actions` (
  ...
  `action_type` enum('BLOCK_USER','UNBLOCK_USER','UPDATE_USER_PROFILE','CREATE_HASHTAG','UPDATE_HASHTAG','DELETE_HASHTAG','HIDE_POST','RESTORE_POST','RESOLVE_REPORT','REJECT_REPORT','RESOLVE_MODERATION_CASE','REJECT_MODERATION_CASE','RESOLVE_PROFILE_REPORT','REJECT_PROFILE_REPORT','CREATE_ACADEMIC_DATA','UPDATE_ACADEMIC_DATA','CHANGE_ACADEMIC_STATUS','CREATE_ADMIN','UPDATE_ADMIN','UPDATE_ADMIN_PROFILE','DISABLE_ADMIN','ENABLE_ADMIN','RESET_ADMIN_PASSWORD','CHANGE_ADMIN_PASSWORD','ASSIGN_ADMIN_ROLE','REVOKE_ADMIN_ROLE','CREATE_ADMIN_ROLE','UPDATE_ROLE_PERMISSIONS','CREATE_MANAGED_SOCIAL_IDENTITY','DISABLE_MANAGED_SOCIAL_IDENTITY','COLLABORATOR_POST_CREATED','COLLABORATOR_POST_UPDATED','COLLABORATOR_POST_DELETED','MODERATION_SUGGESTION_CREATED','MODERATION_SUGGESTION_ACCEPTED','MODERATION_SUGGESTION_REJECTED') NOT NULL,
  `target_type` enum('USER','POST','HASHTAG','REPORT','MODERATION_CASE','PROFILE_REPORT','ACADEMIC_DATA','MODERATION_SUGGESTION') NOT NULL,
...
CREATE TABLE `social_auth_challenges` (
  ...
  CONSTRAINT `chk_social_resolution_action` CHECK ((`resolution_action` is null or `resolution_action` in (_utf8mb4'CONTINUE_OTP',_utf8mb4'CANCEL_PENDING_AND_CONTINUE_SOCIAL',_utf8mb4'LOGIN_EXISTING_ACCOUNT',_utf8mb4'START_ACCOUNT_RECOVERY',_utf8mb4'CONTINUE_WITH_SEPARATE_ACCOUNT'))),
